...
requirejs(["polyfill", "vue", "vue-material", "vue-resource", "loadsh", "jquery", "chartRender", "scripting"],
	function (Polyfill, Vue, VueMaterial, VueResource, loadsh, jquery, chartRender, scripting) {
	Vue.use(VueMaterial)
	Vue.use(VueResource)
