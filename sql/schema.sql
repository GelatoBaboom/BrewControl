...
--
-- Host: localhost    Database: brewcontrol
-- ------------------------------------------------------
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getHours`( startDate datetime) RETURNS int(11)
BEGIN
declare hours int;
set hours = (SELECT TIMESTAMPDIFF(HOUR,startDate,Now())) ;
